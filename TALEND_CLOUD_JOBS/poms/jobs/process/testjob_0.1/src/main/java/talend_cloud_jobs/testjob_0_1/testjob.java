...
package talend_cloud_jobs.testjob_0_1;
...
public class testjob implements TalendJob {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TALEND_CLOUD_JOBS_testjob = new byte[0];
		static byte[] commonByteArray_TALEND_CLOUD_JOBS_testjob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALEND_CLOUD_JOBS_testjob.length) {
					if (length < 1024 && commonByteArray_TALEND_CLOUD_JOBS_testjob.length == 0) {
						commonByteArray_TALEND_CLOUD_JOBS_testjob = new byte[1024];
					} else {
						commonByteArray_TALEND_CLOUD_JOBS_testjob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALEND_CLOUD_JOBS_testjob, 0, length);
				strReturn = new String(commonByteArray_TALEND_CLOUD_JOBS_testjob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALEND_CLOUD_JOBS_testjob) {

				try {

					int length = 0;

					this.names = readString(dis);
...
///////////////////////    			
				...
				for (int itRowGenerator_1 = 0; itRowGenerator_1 < nb_max_row_tRowGenerator_1; itRowGenerator_1++) {
					row1.names = randtRowGenerator_1.getRandomnames();
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = testjob.class.getClassLoader()
					.getResourceAsStream("talend_cloud_jobs/testjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
